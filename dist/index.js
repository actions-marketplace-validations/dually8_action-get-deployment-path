...
// Do this because these are used elsewhere but eslint is dumb :)
var Inputs;
(function (Inputs) {
    Inputs["EnvironmentName"] = "environment-name";
    Inputs["DevPath"] = "dev-path";
    Inputs["StagingPath"] = "staging-path";
    Inputs["ProdPath"] = "prod-path";
})(Inputs = exports.Inputs || (exports.Inputs = {}));
var Outputs;
(function (Outputs) {
    Outputs["DeploymentPath"] = "deployment-path";
...
const set_outputs_1 = __nccwpck_require__(170);
function run() {
...
const core = __importStar(__nccwpck_require__(186));
const constants_1 = __nccwpck_require__(105);
function setOutputs({ devPath, envName, prodPath, stagingPath, }) {
    switch (envName) {
        case "main":
        case "master":
        case "production":
